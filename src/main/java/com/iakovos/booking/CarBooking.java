...
public class CarBooking {
    ...
    private CarBookingStatus status;
    private LocalDateTime bookedAt;

    public CarBooking(UUID id, User user, Car car, LocalDate startDate, LocalDate endDate, BigDecimal price, CarBookingStatus status, LocalDateTime bookedAt) {
        this.id = id;
        this.user = user;
        this.car = car;
    ...
    public CarBookingStatus getStatus() {
        return status;
    }

    public void setStatus(CarBookingStatus status) {
        this.status = status;
    }
